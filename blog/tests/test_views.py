...
from blog.forms import CommentForm, UserForm, PostForm, ProfileForm, ContactForm
import datetime
...
class TestViews(TestCase):
    ...
    def test_create_post(self):
        ...
        # Now, check if the post with the title 'New Post' exists in the database
    ...
    def test_update_post(self):
        ...
        response = self.client.post(reverse('post_update', kwargs={'slug': self.test_post.slug}), {
            'title': 'Test Post',
        ...
        # Refresh the test_post object from the database to get the updated data
    ...
    def test_delete_post(self):
        ...
        response = self.client.post(reverse('post_delete', kwargs={'slug': self.test_post.slug}))
